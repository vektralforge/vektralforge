...
Tests unitarios del job de transformación usando chispa.
Ejecutar: cd spark && pytest tests/ -v
"""
import pytest
...
def test_deduplication(spark):
    """Las filas duplicadas por id deben eliminarse."""
...
def test_inactive_rows_filtered(spark):
    """Las filas con activo=False deben ser excluidas."""
